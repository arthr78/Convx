...
val DownloadDirectoryUriKey = stringPreferencesKey("download_directory_uri")

@OptIn(ExperimentalCoilApi::class, ExperimentalMaterial3Api::class, DelicateCoilApi::class, UnstableApi::class)
@Composable
fun StorageSettings(
    ...
    val (downloadDirUriString, onDownloadDirUriChange) = rememberPreference(
    ...
    val folderPickerLauncher = rememberLauncherForActivityResult(
        ...
        if (uri != null) {
            ...
            onDownloadDirUriChange(uri.toString())
        }
    }
        ...
        Material3SettingsGroup(
            ...
            items = listOf(
                ...
                Material3SettingsItem(
                    ...
                    description = {
                        val folderText = if (downloadDirUriString.isNotBlank()) {
                            runCatching {
                                Uri.parse(downloadDirUriString).lastPathSegment?.substringAfterLast(":")
                            }.getOrNull() ?: downloadDirUriString
                        } else {
                            "Default (Music/Convx)"
                        }
                        Text(text = folderText)
                    },
                    onClick = {
                ...
                Material3SettingsItem(
                    ...
                    description = {
                        ...
                        Column {
                            ...
                            Spacer(modifier = Modifier.padding(2.dp))
                            Text(
                                text = "${formatFileSize(imageCacheSize)} / ${formatFileSize(maxImageCacheSize * 1024 * 1024L)}",
                                style = MaterialTheme.typography.bodyMedium,
                            )
                        }
                    }
